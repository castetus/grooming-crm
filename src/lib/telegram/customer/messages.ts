...
export const BOT_MESSAGES = {
  welcome:
    'Добро пожаловать в бот записи на груминг в салон «Франц и Феня» 🐾\n\n' +
  ...
  bookingCancelled:
    'Запись отменена. Чтобы начать новую запись, отправьте /start.',
  bookingCreated:
    '✅ Заявка отправлена!\n\nПожалуйста, дождитесь сообщения от грумера, для подтверждения даты и времени',
} as const;
